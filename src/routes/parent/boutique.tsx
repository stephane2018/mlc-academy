...
import { ShoppingBag, Download, Check, FileIcon, CreditCard } from '@/components/icons'
...
function ParentBoutique() {
  ...
  const confirmPurchase = (p: MarketProduct) => {
    ...
    toast.success('Achat confirmé', {
      description: `« ${p.title} » est débloqué pour ${parentChild.pseudo}.`,
    })
  }
  ...
  return (
    <div className="space-y-6">
      <PageHero
        ...
        subtitle={`E-books, fiches et packs proposés par les profs pour accompagner ${parentChild.pseudo}.`}
      />
        ...
        {p && (
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Le contenu sera débloqué pour {parentChild.pseudo} dès le paiement validé.
              </DialogDescription>
            </DialogHeader>
            ...
            <p className="flex items-center gap-1.5 rounded-lg bg-brand-soft px-3 py-2 text-xs text-brand">
              ...
              Paiement sécurisé via Stripe — facture disponible dans votre espace.
            </p>
